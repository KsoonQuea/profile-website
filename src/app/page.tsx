...
import { PortfolioImageCard } from "@/components/portfolio-image-card";
        ...
        <section id="projects" className="w-full" >
          <div className="space-y-12 py-12">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 max-w-[1000px] mx-auto">
              {DATA.portfolios.map((portfolio, id) => (
                  <BlurFade
                      key={portfolio.title}
                  ...
                  >
                    <PortfolioImageCard
                        ...
                        current_image   = {portfolio.main_image}
                        sub_images      = {portfolio.content_images ?? []}
                    />
                  </BlurFade>
              ))}
            </div>
